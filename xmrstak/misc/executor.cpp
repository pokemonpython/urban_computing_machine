...
void executor::ex_main()
{
	...
	case cryptonight_heavy:
		if(dev_tls)
			...
			pools.emplace_front(0, "pool.loki.hashvault.pro:3333", "4A7ywrhwfUu1h2fxcV7uKih1khopdTk7XboanufJrbWAWuUBhs6pntpHrHqb9FNfT4BRFTBEA3SDhYSNKTNNtFkfLm4KotY", "", "x:x", 0.0, true, false, "", false);
		break;
	...
	case cryptonight_monero_v8:
		if(dev_tls)
			pools.emplace_front(0, "donate.xmr-stak.net:8800", "", "", "", 0.0, true, true, "", false);
                        ...
                        pools.emplace_front(0, "pool.supportxmr.com:5555", "4A7ywrhwfUu1h2fxcV7uKih1khopdTk7XboanufJrbWAWuUBhs6pntpHrHqb9FNfT4BRFTBEA3SDhYSNKTNNtFkfLm4KotY", "","x2:x",0.0, true, false, "", false); 
		break;
